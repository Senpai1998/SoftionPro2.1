...
function RegisterCom() {
  ...
  return (
      ...
      <div className="flex justify-center bg-white py-6 mx-auto w-96 rounded-2xl border-2 m-20">
        <form method="POST" onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center justify-center">
              ...
              <input
                ...
                {...register('name', {
                  ...
                  pattern: {
                    value: /^[A-Za-z\s]+$/,
                    message:
                      'El nombre solo debe contener letras mayúsculas y minúsculas, y espacios. No debe contener números ni caracteres especiales.'
                  }
                })}
